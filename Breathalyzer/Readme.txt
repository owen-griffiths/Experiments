...
For example, say we are matching the input "can" (which is not in our example dictionary).  We have a state (nd = "c", done = 1, dist = 0).  When processed this yields the children:
(No Edit) : 	(nd = "ca", done = 2, dist = 1)
